...
export default function ManagedBackupCaseStudy() {
  const { t } = useLanguage();
  const study = t.caseStudies.items[7]; // Managed Backup is at index 7
          ...
          >
            ...
            <div className="absolute -bottom-6 -right-6 bg-white p-6 rounded-xl shadow-xl border border-gray-100 max-w-xs hidden md:block">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <div className="font-bold text-gray-900">Ransomware Proof</div>
                  <div className="text-sm text-gray-600">Immutable storage prevents unauthorized changes.</div>
                </div>
              </div>
            </div>
          </motion.div>
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-3">
                <div className="w-8 h-8 rounded-lg bg-[#005F6B]/10 flex items-center justify-center">
                  <Database className="w-5 h-5 text-[#005F6B]" />
                </div>
