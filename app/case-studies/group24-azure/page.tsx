        ...
        <div className="max-w-[1000px] mx-auto">
          ...
          <div className="mb-16">
            ...
            <p className="text-lg text-gray-700 leading-relaxed max-w-3xl">
              ...
              mehr Aufwand, mehr Komplexität und immer weniger Flexibilität umgesetzt werden konnten.
              Ziel war eine Plattform, die im Alltag stabil läuft und mit dem Unternehmen mitwachsen kann.
            </p>

            <div className="mt-6 inline-flex rounded-full bg-gray-100 px-4 py-2 text-sm text-gray-700">
              Projekt umgesetzt im Auftrag eines Partners, operativ eingebunden für Migration, Plattformbetrieb und Stabilisierung.
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <div className="md:col-span-2 space-y-12">
              ...
              <section>
                ...
                <div className="bg-gray-50 p-8 rounded-3xl border border-gray-100 space-y-4">
                  <p className="text-gray-700 leading-relaxed">
                    Die bestehende Umgebung wurde schrittweise in Microsoft Azure überführt und so aufgebaut,
                    dass sie nicht nur technisch migriert, sondern im Betrieb auch sauber beherrschbar bleibt.
                  </p>
                  ...
                  <ul className="space-y-3">
                    {[
                      ...
                      "Unterstützung des IT-Teams im Umgang mit Azure-Ressourcen und Plattformbetrieb"
                    ].map((item, i) => (
              ...
              <section>
                ...
                <div className="grid sm:grid-cols-2 gap-6">
                  <div className="p-6 rounded-2xl bg-primary/5 border border-primary/10">
                    ...
                    <p className="text-sm text-gray-700">
                      Ressourcen können heute deutlich flexibler an neue Anforderungen angepasst werden.
                    </p>
                  </div>
                  ...
                  <div className="p-6 rounded-2xl bg-primary/5 border border-primary/10">
                    ...
                    <p className="text-sm text-gray-700">
                      Wartung und Betrieb wurden spürbar entlastet, weil zentrale Prozesse sauber in die Cloud überführt wurden.
                    </p>
                  </div>
                </div>
                ...
                <p className="mt-6 text-gray-700 leading-relaxed text-lg">
                  ...
                  und eine moderne Arbeitsweise mit sicheren, ortsunabhängigen Zugriffen unterstützt.
                </p>
              </section>
            ...
            <div className="space-y-8">
              <CTASection
                ...
                description="Wenn Systeme wachsen sollen, die Struktur aber nicht mitkommt, schauen wir uns das gemeinsam an – klar, technisch sauber und ohne unnötiges Projekt-Blabla."
