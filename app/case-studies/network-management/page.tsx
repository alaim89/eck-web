...
export default function NetworkManagementCaseStudy() {
  const { t } = useLanguage();
  const study = t.caseStudies.items[8]; // Network Management is at index 8
          ...
          >
            <div className="aspect-video rounded-2xl overflow-hidden bg-gray-100 shadow-2xl relative group">
              <Image 
                ...
                alt="Warehouse Network Infrastructure"
                fill
            ...
            <div className="absolute -bottom-6 -right-6 bg-white p-6 rounded-xl shadow-xl border border-gray-100 max-w-xs hidden md:block">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <div className="font-bold text-gray-900">Seamless Roaming</div>
                  <div className="text-sm text-gray-600">No more connection drops across 50,000 sq ft.</div>
                </div>
              </div>
            </div>
          </motion.div>
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-3">
                <div className="w-8 h-8 rounded-lg bg-[#005F6B]/10 flex items-center justify-center">
                  <Activity className="w-5 h-5 text-[#005F6B]" />
                </div>
