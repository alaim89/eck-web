...
import { Building2, Users, MessageCircle, ArrowRight, CheckCircle2 } from "lucide-react";
    ...
    <form onSubmit={handleSubmit} className="space-y-8">
      <div className="grid md:grid-cols-2 gap-6">
        <div className="space-y-2">
          <label htmlFor="name" className="text-xs font-bold text-gray-400 uppercase tracking-widest ml-1">Name</label>
          <input 
            id="name"
            name="name"
            type="text" 
