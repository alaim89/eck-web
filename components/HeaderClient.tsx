...
export function HeaderClient({ t }: HeaderClientProps) {
  ...
  return (
    <>
      ...
      {/* Mobile Menu */}
      {isMobileMenuOpen && (
        <div className="md:hidden absolute top-20 left-0 w-full bg-white border-t border-slate-100 p-8 space-y-8 animate-in slide-in-from-top-4 duration-300 overflow-y-auto max-h-[calc(100vh-80px)] shadow-2xl">
