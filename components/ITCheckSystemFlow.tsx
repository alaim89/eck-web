  ...
  return (
    <section aria-labelledby="system-flow-heading" className="relative px-6 py-20">
      <div className="max-w-[1080px] mx-auto">
        ...
        <div className="relative overflow-hidden rounded-[2.5rem] bg-white px-6 py-10 md:px-10 md:py-14 shadow-[0_50px_90px_-46px_rgba(15,23,42,0.5)] border border-slate-200/70">
          ...
          <div className="relative my-11 rounded-2xl bg-slate-50/70 px-4 py-6 md:px-8">
            ...
            <div className="mt-12 space-y-3 md:grid md:grid-cols-2 md:gap-5 md:space-y-0">
              {routingBranches.map((branch) => (
                <p key={branch} className="text-sm leading-[1.6] text-slate-700 md:text-center border-b border-slate-200/70 md:border-b-0 pb-2 md:pb-0">
                  {branch}
                </p>
              ))}
            </div>
